...
def print_human_report(results):
    ...
    ex_titles = {
        "ej1_definicion": "Ej 1: Definición y Rol del Sistema Operativo",
        "ej2_funciones_so": "Ej 2: Funciones y Responsabilidades del SO",
        "ej3_multithreading_vs_multicore": "Ej 3: Multihilamiento vs. Multinúcleo",
        "ej4_programa_vs_proceso": "Ej 4: Programa vs. Proceso (Entidad Pasiva / Activa)",
        "ej5_funciones_situaciones": "Ej 5: Componentes del SO en Situaciones Cotidianas",
        "ej6_modo_usuario_kernel": "Ej 6: Modo Dual: Modo Usuario (MU) vs Modo Kernel (MK)",
        "ej7_estructuras_kernel_vf": "Ej 7: Estructuras del Kernel y Arquitecturas (V/F)",
        "ej8_tipos_sistemas_operativos": "Ej 8: Clasificación de Sistemas Operativos",
        "ej9_arquitectura_proteccion_mc": "Ej 9: Arquitectura, DMA y Mecanismos de Protección",
        "ej10_mecanismos_vs_politicas": "Ej 10: Principio de Diseño: Mecanismos vs Políticas"
    }
...
def write_github_step_summary(results):
    ...
    try:
        ...
        lines = [
            ...
            "### Trabajo Práctico N° 1: Introducción a los Sistemas Operativos y Estructuras de Computación",
            "",
        ...
        if not passed:
            ...
            lines.append("> **Tu entrega aún no alcanza los criterios de aprobación.** Consulta los capítulos bibliográficos indicados en la tabla superior, abre `index.html` para ajustar tus respuestas, exporta un nuevo `respuestas_tp1.json` y vuelve a hacer `git push origin main`.")
        else:
            lines.append("> [!TIP]")
...
def main():
    parser = argparse.ArgumentParser(description="Autoevaluador de TP1 - Teoría de Sistemas Operativos (UNJu FI)")
    parser.add_argument("submission", nargs="?", default="respuestas_tp1.json", help="Ruta al archivo respuestas_tp1.json")
    parser.add_argument("--rubric", default=RUBRIC_FILE, help="Ruta a rubric_tp1.json")
